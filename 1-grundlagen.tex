...
\subsection{Quadratische Gleichung} % (fold)
...
% subsubsection loesung (end)

\subsubsection{Gekürzte Lösung} % (fold)
\label{ssub:gekuerzte_loesung}
\begin{eqnarray}
  x^2+px+q=0\\
  x_{1,2}=-\frac{p}{2}\pm\sqrt{\left(\frac{p}{2}\right)^2-q}
\end{eqnarray}
% subsubsection gekuerzte_loesung (end)
% subsection quadratische_gleichung (end)
...
\subsubsection{Homogene lineare Differentialgleichung} % (fold)
\label{ssub:homogene_lineare_differentialgleichung}
\begin{eqnarray}
  y(x) &=& C \cdot e^{\lambda x} \\
  y'(x) &=& \lambda Ce^{\lambda x} \\
  y''(x) &=& \lambda Ce^{\lambda x}
\end{eqnarray}
% subsubsection homogene_lineare_differentialgleichung (end)

\subsection{Spezielle Werte} % (fold)
\label{sub:spezielle_werte}
\subsubsection{Sinus und Cosinus Funktionen} % (fold)
...
% subsubsection sinus_und_cosinus_funktion (end)
% subsection spezielle_werte (end)

\subsubsection{Logarithmus} % (fold)
\label{ssub:logarithmus}
\begin{equation}
  c=ln(x+y) \rightarrow e^c=x+y
\end{equation}
% subsubsection logarithmus (end)
